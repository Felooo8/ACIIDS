...
def main():
    ...
    specific_option_id = selected_option_id  # Replace with desired option ID
    ...
    sequences_file = 'sequences_full.pkl'
    ...
    model_path = 'models/option_pricing_model_lstm_full.keras'
    ...
    plot_feature_importance_heatmap(model, X_val, features)
    ...
    agent_path = 'models/option_trading_agent_full'
    ...
    plt.tight_layout()
    plt.savefig('net_worth_over_time_plot2.pdf')
    plt.show()
